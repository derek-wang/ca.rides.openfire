...
public class SessionManager extends BasicModule implements ClusterEventListener {
     ...
     *
     */
    public void sendServerMessage(Message historyMessage, JID targetJID) {
        ...
        if (address == null || address.getNode() == null || !userManager.isRegisteredUser(address)) {
            ...
            userBroadcast(address.getNode(), historyMessage);
        }
        else {
            routingTable.routePacket(address, historyMessage, true);
        }
    }
